...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($lastname)) {
            ...
            $isOk = filter_var($lastname, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => '/' . REGEXP_LASTNAME . '/')));
            if (!$isOk) {
        ...
        if (empty($firstname)) {
            ...
            $isOk = filter_var($firstname, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => '/' . REGEXP_FIRSTNAME . '/')));
            if (!$isOk) {
...
include(__DIR__ . '/../views/patients/add-patient.php');
